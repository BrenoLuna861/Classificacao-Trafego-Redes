...
def grafico_distribuicao_classes(treino: pd.DataFrame):
    ...
    plt.tight_layout()
    plt.savefig('outputs/g1_distribuicao_classes.png', dpi=150)
    plt.show()
...
def grafico_protocolo_por_classe(treino: pd.DataFrame):
    ...
    plt.tight_layout()
    plt.savefig('outputs/g2_protocolo.png', dpi=150)
    plt.show()
...
def grafico_src_bytes(treino: pd.DataFrame):
    ...
    plt.tight_layout()
    plt.savefig('outputs/g3_src_bytes.png', dpi=150)
    plt.show()
...
def grafico_correlacao(treino: pd.DataFrame):
    ...
    plt.tight_layout()
    plt.savefig('outputs/g4_correlacao.png', dpi=150)
    plt.show()
...
def grafico_dst_bytes(treino: pd.DataFrame):
    ...
    plt.tight_layout()
    plt.savefig('outputs/g5_dst_bytes.png', dpi=150)
    plt.show()
...
def grafico_matrizes_confusao(predicoes: dict, y_teste):
    ...
    plt.tight_layout()
    plt.savefig('outputs/matrizes_confusao.png', dpi=150)
    plt.show()
